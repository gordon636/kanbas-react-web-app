    ...
    return (
        <div>
            ...
            >
                ...
                <option value="FACULTY">Show Faculty</option>
            ...
            <table className="table">
                <thead>
                    ...
                    <tr>
                        ...
                        <td>
                            <input value={user.firstName} placeholder="First Name" onChange={(e) =>
                                setUser({ ...user, firstName: e.target.value })} />
                        </td>
                        <td>
                            <input value={user.lastName} placeholder="Last Name" onChange={(e) =>
                        ...
                        <td>
                            ...
                            />
                            <BsPlusCircleFill className="me-2 text-success fs-1 text"
                                onClick={createUser} />
                        </td>
                    </tr>
                </thead>
